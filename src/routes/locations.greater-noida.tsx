...
const title = "Bridal Makeup Artist in Greater Noida | Shreya Chaudhary Makeup";
const description =
  ...
  return (
    <>
      <PageHero
        ...
        intro={`${business.artist} offers luxury on-location bridal and event makeup across ${city} and Greater Noida West (Noida Extension).`}
