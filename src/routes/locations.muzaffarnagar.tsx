...
const description =
  "Best bridal makeup artist in Muzaffarnagar. Shreya Chaudhary provides luxury HD bridal (₹15,000), engagement (₹8,000), and party makeup with on-location hairstyling in Muzaffarnagar, UP.";
