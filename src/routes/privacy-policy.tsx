        ...
        <div className="max-w-3xl space-y-10">
          <section>
            ...
            <p className="mt-4 text-base leading-relaxed text-muted-foreground">
              This website has no contact form, no account system and no database. Nothing you
              type is stored here. Buttons labelled for WhatsApp open a chat in WhatsApp with a
              message prepared for you; you choose whether to send it.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4 text-base leading-relaxed text-muted-foreground">
              When you message {business.artist}, you typically share your name, phone number,
              event date and location. That information is used only to answer your enquiry,
              check availability and deliver your booking. It is not sold, published or shared
              for marketing. WhatsApp's own privacy terms apply to the conversation itself.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4 text-base leading-relaxed text-muted-foreground">
              Client photographs appear on this website or on Instagram only where the client
              is comfortable with them being shared. If you would prefer your photographs not
              to be used, say so on WhatsApp and they will not be published.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4 text-base leading-relaxed text-muted-foreground">
              If website analytics are enabled, they record anonymous usage such as which pages
              are visited and which buttons are tapped. They do not identify you personally.
            </p>
          </section>
